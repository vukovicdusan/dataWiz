      ...
      <section className="mt-10 py-10">
        <div className="mx-auto max-w-4xl text-center flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p>
              Unless otherwise stated, DataWiz LLC and/or its licensors own the intellectual property rights for all material on{" "}
              <a href="https://datawizanalytics.com/" className="text-primaryAccent hover:text-white">
                datawizanalytics.com/
              </a>
            ...
            <p className="font-bold">You must not:</p>
            <ul>
              <li>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p>Comments do not reflect the views and opinions of DataWiz LLC, its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions.</p>
            <p>To the extent permitted by applicable laws, DataWiz LLC shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>
            <p>DataWiz LLC reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
          </div>
          <div className="flex flex-col gap-4">
            ...
            <p>You hereby grant DataWiz LLC a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
          </div>
          <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of DataWiz LLC; and (d) the link is in the context of general resource information.</p>
            <p>These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products or services; and (c) fits within the context of the linking party's site.</p>
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to DataWiz LLC.</p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-bold">Nothing in this disclaimer will:</p>
            <ul>
