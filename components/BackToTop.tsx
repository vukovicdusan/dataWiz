...
const BackToTop = () => {
	...
	return (
		<button
			...
			} fixed bottom-6 right-6 p-2 border-[2px] border-[rgba(255,255,255,0.4)] rounded-full bg-primaryAccent opacity-20 z-20 transition-transform duration-300 ease-in-out group`}
			onClick={scrollToTop}
		>
