        ...
        <section className="bg-secondaryAccent">
          ...
          <div className="flex flex-wrap-reverse justify-between mx-aut lg:flex-wrap ">
            <div className="lg:basis-1/2 md:basis-full justify-start">
              ...
              <p className="mb-4 text-left">
                He has always had a taste for adventure and breaking out of his
                comfort zone. Not surprisingly, you can often find him planning
                his next big trip. He&apos;s a globetrotter, even if he would
                never use that word.
              </p>
            </div>
